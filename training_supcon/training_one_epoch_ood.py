...
def train_ood(train_loader, model, criterion, optimizer, epoch, opt):
    """one epoch training"""
    model.train()
    ...
    for idx, (images, bcva,cst,eye_id,patient,msp,odin,mahal) in enumerate(train_loader):
        ...
        if opt.method1 == 'patient':
            ...
            labels1 = eye_id.cuda()
        elif opt.method1 =='msp':
            labels1 = msp.cuda()
        elif opt.method1 =='odin':
            labels1 = odin.cuda()
        elif opt.method1 =='mahal':
            labels1 = mahal.cuda()
        else:
            labels1 = 'Null'
        # Method 2
        if opt.method2 == 'patient':
            ...
            labels2 = cst.cuda()
        elif opt.method2 == 'msp':
            labels2 = msp.cuda()
        elif opt.method2 == 'odin':
            labels2 = odin.cuda()
        elif opt.method2 == 'mahal':
            labels2 = mahal.cuda()
        ...
        if opt.method3 == 'patient':
            ...
            labels3 = cst.cuda()
        elif opt.method3 =='msp':
            labels3 = msp.cuda()
        elif opt.method3 =='odin':
            labels3 = odin.cuda()
        elif opt.method3 =='mahal':
            labels3 = mahal.cuda()
        ...
        if opt.method4 == 'patient':
            ...
            labels4 = cst.cuda()
        elif opt.method4 == 'msp':
            labels4 = msp.cuda()
        elif opt.method4 == 'odin':
            labels4 = odin.cuda()
        elif opt.method4 == 'mahal':
            labels4 = mahal.cuda()
        ...
        if opt.method5 == 'patient':
            ...
            labels5 = cst.cuda()
        elif opt.method5 == 'msp':
            labels5 = msp.cuda()
        elif opt.method5 == 'odin':
            labels5 = odin.cuda()
        elif opt.method5 == 'mahal':
            labels5 = mahal.cuda()
