...
def parse_option():
    ...
    parser.add_argument('--train_csv_path', type=str, default='cuda:0')
    # optimization
    ...
    parser.add_argument('--dataset', type=str, default='TREX_DME',
                        choices=['cifar10', 'cifar100', 'path', 'OCT', 'OCT_Cluster', 'Prime', 'PrimeBio',
                                 'Recovery_Compressed','covid_kaggle','Chexpert','Chexpert_Cluster',
                                 'Prime_Comb_Bio', 'CombinedBio', 'CombinedBio_Modfied', 'Patient_Split_2_Prime_TREX',
                                 'Patient_Split_3_Prime_TREX', 'GradCon','Grad','GradCon_Noise',
                                 'Prime_Compressed', 'Prime_TREX_DME_Fixed', 'Prime_TREX_Alpha',
                                 'Prime_TREX_DME_Discrete', 'OOD',
                                 'Recovery', 'Alpha', 'Prime_Comb_Bio_Update', 'Prime_Bio_Comb_Resize', 'Ford',
                                 'TREX_DME','Ford_Region'], help='dataset')
